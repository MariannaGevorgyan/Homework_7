...
def test_shop():
    ...
    product.wait_load(10, "inventory_item")
    ...
    product.wait_load(10, "cart_item")

    checkout = Checkout(browser)
    checkout.button("checkout")

    form = Form(browser)
    form.wait_load_id(10, "first_name")
    form.fill_form("first_name", "Marianna")
    form.fill_form("last_name", "Gevorgyan")
    form.fill_form("postal-code", "171401")

    form.click_form("continue")

    product.wait_load(10, "summary_info")
